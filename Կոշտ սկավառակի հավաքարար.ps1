...
$SelectDiskLabelText = "Ընտրեք սկավառակ."
$FreeSpaceLabelText = "Ազատ տարածություն (գիգաբայթ)"
$TotalSpaceLabelText = "Ընդհանուր տարածություն (գիգաբայթեր)."
$JunkFoundLabelText = "Գտնվել է աղբ (գիգաբայթ):"
$CleanDiskBtnText = "Մաքրել սկավառակը *Ջնջում է ֆայլերը*"
$SpaceCleanedLabelText = "Տիեզերքը մաքրված է (գիգաբայթեր)."
$LogFileLabelText = "Մատյան ֆայլը գտնվում է. $abcdefg"
$CreditLabelText = "Սցենարը Ջիմ Թայլերի կողմից - PowerShellEngineer.com"
$LogFileLocatedText = "Գտնված է մատյան ֆայլը"
$AnalyzingDriveText = "Վերլուծվում է կրիչներ..."
$BrowsersAreRunningText = "Բրաուզերներն աշխատում են... ծանուցում օգտվողին..."
$PleaseCloseBrowsersText = "Փակեք բոլոր վեբ բրաուզերները և նորից փորձեք"
$CleaningDriveText = "Սարքի մաքրում..."
...
$FreeSpaceValue.location = New-Object System.Drawing.Point(431,57)
...
$TotalSpaceValue.location = New-Object System.Drawing.Point(431,91)
...
$JunkFoundValue.location = New-Object System.Drawing.Point(431,125)
...
$SpaceCleanedValue.location = New-Object System.Drawing.Point(431,219)
